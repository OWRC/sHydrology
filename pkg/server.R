...
source("pkg/leaflet-marker-click.R", local=TRUE)$value
source("pkg/leaflet-map-click.R", local=TRUE)$value
source("pkg/dygraph.R", local=TRUE)$value
source("pkg/download.R", local=TRUE)$value
